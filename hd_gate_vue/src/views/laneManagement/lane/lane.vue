    ...
    <el-main>
      ...
      <div>
        <el-table :data="tableData" stripe style="width: 100%">
          ...
          <el-table-column align="center" label="操作"><!--操作-->
            <template slot-scope="scope">
              ...
              <el-button type="warning" @click="openLight(scope.row)" size="small">抬杆</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-dialog title="提示" :visible.sync="dialogVisible" width="30%">
          ...
          <el-row>
            <el-col :span="12">
              开灯时间<el-date-picker v-model="lightOnTime" type="datetime" placeholder="请选择开灯时间"></el-date-picker>
            </el-col>
            <el-col :span="12">
              关灯时间
              <el-date-picker v-model="lightOffTime" type="datetime" placeholder="请选择关灯时间"></el-date-picker>
            </el-col>
          </el-row>
